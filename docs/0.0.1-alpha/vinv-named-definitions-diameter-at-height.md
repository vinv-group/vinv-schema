...
```txt
https://schema.vinv.io/0.0.1-alpha/vinv-named.min.json#/definitions/tree/properties/crown/items
```
...
| :-------------------- | :------- | :------- | :------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [height](#height)     | `number` | Optional | cannot be null | [vinv](vinv-named-definitions-diameter-at-height-properties-height.md "https://schema.vinv.io/0.0.1-alpha/vinv-named.min.json#/definitions/diameter_height/properties/height")     |
