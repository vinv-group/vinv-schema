...
```txt
https://schema.vinv.io/0.0.1-alpha/vinv-named-openapi.min.json#/definitions/track_history/items/0
```
...
`string` ([Track Id](vinv-named-openapi-definitions-track-changes-items-track-id.md))
