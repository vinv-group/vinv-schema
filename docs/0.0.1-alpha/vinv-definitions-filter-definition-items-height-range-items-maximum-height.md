...
```txt
https://schema.vinv.io/0.0.1-alpha/vinv.min.json#/definitions/filter/items/3/items/1
```
...
`number` ([Maximum height](vinv-definitions-filter-definition-items-height-range-items-maximum-height.md))
