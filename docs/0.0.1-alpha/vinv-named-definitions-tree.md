...
```txt
https://schema.vinv.io/0.0.1-alpha/vinv-named.min.json#/definitions/trees_history/properties/definition
```
...
| :-------------------- | :------- | :------- | :------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [id](#id)             | `string` | Optional | cannot be null | [vinv](vinv-named-definitions-id.md "https://schema.vinv.io/0.0.1-alpha/vinv-named.min.json#/definitions/tree/properties/id")                                         |
...
| [species](#species)   | `string` | Required | cannot be null | [vinv](vinv-named-definitions-tree-species.md "https://schema.vinv.io/0.0.1-alpha/vinv-named.min.json#/definitions/tree/properties/species")                          |
...
*   Type: `string` ([Tree Id](vinv-named-definitions-id.md))

*   cannot be null

*   defined in: [vinv](vinv-named-definitions-id.md "https://schema.vinv.io/0.0.1-alpha/vinv-named.min.json#/definitions/tree/properties/id")

### id Type

`string` ([Tree Id](vinv-named-definitions-id.md))
...
*   Type: `string` ([Tree species](vinv-named-definitions-tree-species.md))

*   cannot be null

*   defined in: [vinv](vinv-named-definitions-tree-species.md "https://schema.vinv.io/0.0.1-alpha/vinv-named.min.json#/definitions/tree/properties/species")

### species Type

`string` ([Tree species](vinv-named-definitions-tree-species.md))
...
*   Type: `string[]` ([Images](vinv-named-definitions-images.md))
...
`string[]` ([Images](vinv-named-definitions-images.md))
