...
1.  [Longitude](0-properties-trees-items-tree-tree-definition-items-location-items-coordinates-items-longitude.md "check type definition")
2.  [Latitude](0-properties-trees-items-tree-tree-definition-items-location-items-coordinates-items-latitude.md "check type definition")
3.  and all following items must follow the schema: [\[Altitude\]](0-properties-trees-items-tree-tree-definition-items-location-items-coordinates-altitude.md "check type definition")
