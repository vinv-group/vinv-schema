...
```txt
https://raw.githubusercontent.com/vinv-group/vinv-schema/documentation/dist/0.1-alpha.schema.min.json#/definitions/coordinates/items/2
```
...
`number` ([\[Altitude\]](0-definitions-coordinates-items-altitude.md))
