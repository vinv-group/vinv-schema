...
```txt
https://raw.githubusercontent.com/vinv-group/vinv-schema/documentation/dist/0.1-alpha.schema.min.json#/definitions/track_history/items/0
```
...
`string` ([Track Id](0-definitions-track-changes-items-track-id.md))
