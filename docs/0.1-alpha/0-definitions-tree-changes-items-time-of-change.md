...
```txt
https://raw.githubusercontent.com/vinv-group/vinv-schema/documentation/dist/0.1-alpha.schema.min.json#/definitions/trees_history/items/1
```
...
`string` ([Time of Change](0-definitions-tree-changes-items-time-of-change.md))
