...
```txt
https://raw.githubusercontent.com/vinv-group/vinv-schema/documentation/dist/0.1-alpha.schema.json#/definitions/tree/items/2
```
...
`number` ([Diameter at Breast Height](0-definitions-tree-definition-items-diameter-at-breast-height.md))
