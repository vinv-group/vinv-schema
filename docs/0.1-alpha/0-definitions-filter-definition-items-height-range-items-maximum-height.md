...
```txt
https://raw.githubusercontent.com/vinv-group/vinv-schema/documentation/dist/0.1-alpha.schema.min.json#/definitions/filter/items/3/items/1
```
...
`number` ([Maximum height](0-definitions-filter-definition-items-height-range-items-maximum-height.md))
