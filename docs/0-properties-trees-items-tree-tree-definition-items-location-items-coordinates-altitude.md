...
```txt
https://raw.githubusercontent.com/vinv-group/vinv-schema/main/dist/0.1-alpha.min.json#/properties/trees/items/0/additionalProperties/items/0/items/0/additionalItems
```
...
`number` ([\[Altitude\]](0-properties-trees-items-tree-tree-definition-items-location-items-coordinates-altitude.md))
