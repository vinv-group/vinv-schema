...
```txt
https://raw.githubusercontent.com/vinv-group/vinv-schema/main/dist/0.1-alpha.min.json#/properties/roads/items/1/items/items/0
```
...
`string` ([Track Id](0-properties-roads-items-1-changes-items-track-id.md))
