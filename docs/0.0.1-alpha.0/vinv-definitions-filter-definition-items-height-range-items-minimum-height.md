...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv.min.json#/definitions/filter/items/3/items/0
```
...
`number` ([Minimum height](vinv-definitions-filter-definition-items-height-range-items-minimum-height.md))
