...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-type.min.json#/definitions/diameter_height
```
...
`object` ([Diameter at height](vinv-type-definitions-diameter-at-height.md))
...
| :-------------------- | -------- | -------- | -------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [height](#height)     | `number` | Optional | cannot be null | [vinv](vinv-type-definitions-diameter-at-height-properties-height.md "https&#x3A;//schema.vinv.io/0.0.1-alpha.0/vinv-type.min.json#/definitions/diameter_height/properties/height")     |
