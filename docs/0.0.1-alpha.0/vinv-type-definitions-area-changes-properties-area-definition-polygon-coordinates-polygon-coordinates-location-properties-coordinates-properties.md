...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-type.min.json#/definitions/area_history/properties/definition/items/items/items/properties/coordinates/properties
```
