...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-named.min.json#/definitions/trees_history/properties/definition
```
...
| :-------------------- | -------- | -------- | -------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [id](#id)             | `string` | Optional | cannot be null | [vinv](vinv-named-definitions-tree-properties-tree-id.md "https&#x3A;//schema.vinv.io/0.0.1-alpha.0/vinv-named.min.json#/definitions/tree/properties/id")                    |
...
| [species](#species)   | `string` | Required | cannot be null | [vinv](vinv-named-definitions-tree-species.md "https&#x3A;//schema.vinv.io/0.0.1-alpha.0/vinv-named.min.json#/definitions/tree/properties/species")                          |
...
-   cannot be null
-   defined in: [vinv](vinv-named-definitions-tree-species.md "https&#x3A;//schema.vinv.io/0.0.1-alpha.0/vinv-named.min.json#/definitions/tree/properties/species")
