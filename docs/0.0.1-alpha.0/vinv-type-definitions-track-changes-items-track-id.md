...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-type.min.json#/definitions/track_history/items/0
```
...
`string` ([Track Id](vinv-type-definitions-track-changes-items-track-id.md))
