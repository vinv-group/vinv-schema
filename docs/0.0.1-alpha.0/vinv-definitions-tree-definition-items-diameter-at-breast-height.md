...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv.min.json#/definitions/tree/items/2
```
...
`number` ([Diameter at Breast Height](vinv-definitions-tree-definition-items-diameter-at-breast-height.md))
