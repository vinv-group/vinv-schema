...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-named-openapi.min.json#/definitions/filter/items/3/items/1
```
...
`number` ([Maximum height](vinv-named-openapi-definitions-filter-definition-items-height-range-items-maximum-height.md))
