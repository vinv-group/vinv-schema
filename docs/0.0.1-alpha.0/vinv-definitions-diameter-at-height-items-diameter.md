...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv.min.json#/definitions/diameter_height/items/1
```
...
`number` ([Diameter](vinv-definitions-diameter-at-height-items-diameter.md))
