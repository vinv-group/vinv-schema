...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-type.min.json#/properties/areas/properties/area_history/items/properties/definition/items/items/items/properties/coordinates/properties
```
