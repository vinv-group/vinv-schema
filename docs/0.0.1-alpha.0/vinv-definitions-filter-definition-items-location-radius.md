...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv.min.json#/definitions/filter/items/0
```
...
2.  [Radius](vinv-definitions-filter-definition-items-location-radius-items-radius.md "check type definition")
