...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-type.min.json#/definitions/trees_history/properties/definition/properties/location/properties/coordinates/properties
```
