...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-type.min.json#/definitions/tree
```
...
`object` ([Tree](vinv-type-definitions-tree.md))

# Tree Properties

| Property              | Type     | Required | Nullable       | Defined by                                                                                                                                                                 |
| :-------------------- | -------- | -------- | -------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [id](#id)             | `string` | Optional | cannot be null | [vinv](vinv-type-definitions-tree-properties-id.md "https&#x3A;//schema.vinv.io/0.0.1-alpha.0/vinv-type.min.json#/definitions/tree/properties/id")                         |
