...
```txt
https://schema.vinv.io/0.0.1-alpha.0/vinv-named-openapi.min.json#/definitions/track_history/items/1
```
...
`string` ([Change](vinv-named-openapi-definitions-track-changes-items-change.md))
